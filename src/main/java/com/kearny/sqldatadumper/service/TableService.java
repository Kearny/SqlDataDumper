...
public class TableService {
    ...
    void hydrateTable(Table table) throws SQLException, IOException {
//
...
//        writer.flush();
    ...
    void findColumnsProperties(Table table) throws SQLException {
    ...
    void findAllRowsData(Table table) throws SQLException {
...
//                        table.setValue(column.getOrdinal(), simpleDateFormat.format(date) + "000");
//                    }
...
//                values.add(column.getValueToString());
//            }
//
//            table.setInsert(
//                    String.format(
